...
OMP_NUM_THREADS=2 mpirun.actual -n 3 valgrind --track-origins=yes --leak-check=full --verbose HPC/BFR/src/BFR_parallel.o HPC/BFR/data/synthetic/synthetic_d2.txt > HPC/BFR/output.txt 2>&1 # Full debug setup
